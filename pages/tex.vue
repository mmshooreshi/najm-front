<template>
  ...
  <TexPop
    ...
    :paragraphes="[
      ...
      {delay: '100ms', sentence: 'از طراحی و انتخاب متریال تا انجام چاپ و بسته بندی محصول، با تجربه، </br>دید تخصصی و تیم یکپارچه، همه‌چیز رو متناسب با خواسته‌ت می‌چینیم.'}
    ]"
    :bounce-scale="1.1"
    :bounce-duration="0.2"
    :type-speed="20"
