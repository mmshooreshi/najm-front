...
useAppSeo({
  title: computed(() => ui.value?.title || 'پرسش‌های متداول (FAQ) | چاپ و بسته‌بندی نجم'),
  description: computed(() => ui.value?.subtitle || 'پاسخ کامل به تمامی سوالات مرتبط با حداقل تیراژ، فرمت فایل‌های چاپی، زمان‌بندی تولید و سفارشات در مجتمع چاپ نجم.'),
  type: 'faq',
  slug: 'faq',
  faqItems: computed(() => faqsList.value)
})
</script>
