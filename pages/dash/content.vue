...
const dataStore = reactive<Record<'fa' | 'en' | 'ar', Record<string, string>>>({
  fa: {
    ...
    'contact.address.label': 'تهران، بزرگراه فتح، زیر پل شیر پاستوریزه، ابتدای ۴۵ متری زرند، نبش کوچه تلفن‌خانه، پلاک ۱۶۶',
    'contact.phones.label': '۰۲۱-۶۶۷۹۷۹۱۱ الی ۱۳ | ۰۲۱-۶۶۷۸۹۵۷۷ | ۰۹۹۰۳۴۰۰۰۷۴',
  ...
  en: {
    ...
    'contact.address.label': 'No. 166, Corner of Telefonkhaneh Alley, Beginning of 45-Metri Zarand, Under Shir Pasteurizeh Bridge, Fath Highway, Tehran, Iran',
    'contact.phones.label': '+98 21 6679 7911-3 | +98 21 6678 9577 | +98 990 340 0074',
  ...
  ar: {
    ...
    'contact.address.label': 'طهران، طريق فتح السريع، أسفل جسر شير باستوريزه، بداية ٤٥ متري زرند، ناصية زقاق تلفن خانة، رقم ١٦٦',
    'contact.phones.label': '+98 21 6679 7911-3 | +98 21 6678 9577 | +98 990 340 0074',
