      ...
      <div class="lg:col-span-6 space-y-6" :class="isRTL ? 'text-right' : 'text-left'">
        <div>
          <span
            ...
            v-editable="'badge'"
          >
            {{ product.badge || 'خدمات چاپ تجاری، اداری و کاتالوگ' }}
          </span>
          <h1
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-3">
          ...
          <div class="p-3.5 rounded-2xl bg-najmgrey/50 border border-najmborder/40 col-span-2 sm:col-span-1">
            ...
            <span class="text-xs sm:text-sm font-bold text-gray-900 break-words" v-editable="'printType'">{{ product.printType || 'افست ۵ رنگ هایدلبرگ' }}</span>
          </div>
        </div>
        ...
        <div class="space-y-2.5 pt-2">
          <h3 class="text-xs font-bold text-gray-900 uppercase tracking-wider text-d4 break-words" v-editable="'papersTitle'">
            {{ product.papersTitle || 'انواع کاغذ و گرماژ قابل سفارش:' }}
          </h3>
        ...
        <div class="space-y-2.5">
          <h3 class="text-xs font-bold text-gray-900 uppercase tracking-wider text-d4 break-words" v-editable="'finishesTitle'">
            {{ product.finishesTitle || 'پوشش‌ها و صحافی:' }}
          </h3>
          <div class="flex flex-wrap gap-2">
            <span
        ...
        <div class="pt-4 flex flex-col sm:flex-row gap-3">
          ...
          >
            <span v-editable="'inquiryBtn'">{{ product.inquiryBtn || 'استعلام تیراژ و قیمت چاپ' }}</span>
          </NuxtLink>
          <NuxtLink
          ...
          >
            ...
            <span v-editable="'guideBtn'">{{ product.guideBtn || 'راهنمای تنظیم رنگ CMYK' }}</span>
          </NuxtLink>
        </div>
      </div>
    </div>
