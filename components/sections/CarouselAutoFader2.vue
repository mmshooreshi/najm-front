<!-- components/sections/CarouselAutoFader2.vue -->
...
const slides = ref([
  {
    image: 'https://dashboard.codeparrot.ai/api/image/Z8MAvVj1kitRpYP1/frame-32.png',
  ...
  <div  class="relative">
    <ClientOnly>
      ...
      >
        ...
        <div :id="`pagination-${uniqueId}`" class="swiper-pagination  h-min !bottom-8 gap-1 !w-full"></div>
      </swiper-container>
    </ClientOnly>
  </div>
</template>
