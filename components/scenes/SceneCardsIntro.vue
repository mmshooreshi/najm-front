...
<template>
  <div class="snap-start flex flex-col flex-grow  w-full h-full  gap-12  pt-12">
    ...
    <ClientOnly>
      <TexPop :highlights="sceneCardsIntro.highlightedText" :paragraphes="sceneCardsIntro.paragraphes" :bounce-scale="1.1" :bounce-duration="0.2"
        :type-speed="20" animation-type="split" :scrub="false" />
    </ClientOnly>
  </div>
